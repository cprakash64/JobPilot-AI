...
def evaluate(data: dict) -> dict:
    ...
    metrics = {
        "recruiter_precision_at_1": precision(category_items["recruiter"], 1),
        "recruiter_precision_at_3": precision(category_items["recruiter"], 3),
        "potential_hiring_manager_precision_at_1": precision(category_items["manager"], 1),
        "referral_precision_at_3": precision(category_items["referral"], 3),
        "referral_precision_at_5": precision(category_items["referral"], 5),
